...
//Дано натуральное трехзначное число.Создайте массив,состоящий из цифр этого числа.Младший разряд числа должен распологаться
// на 0-м индиксе масива - на 2-м 

// Random rand = new Random();

// int num = rand.Next(100, 1000);
// System.Console.WriteLine("Сгенерированное число: " + num);
